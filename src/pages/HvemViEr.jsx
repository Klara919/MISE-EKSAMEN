...
import styles from "./HvemViEr.module.css";
  ...
  return (
    <section className="cases" data-sidebrand="beige">
      <div className={styles.page}>
        ...
        <main className={styles.hvemContainer}>
          <section className={styles.hvemIntro}>
            <p className={styles.hvemEyebrow}>Hvem vi er</p>

            <h1 className={styles.hvemHeading}>Hvem er teamet bag MiSE?</h1>

            <p className={styles.hvemText}>
              Bag MiSE står et passioneret team med en fælles ambition om at skabe
              digitale løsninger, der gør en forskel. Vi arbejder med fokus på
              æstetik, kvalitet og gennemtænkte valg, hvor bæredygtighed indgår
              som en naturlig del af vores tilgang til design og udvikling.
            </p>
          </section>
